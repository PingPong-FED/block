...
import { ReattemptOptions } from 'reattempt'
...
export default class Store {
   ...
   * 注册block模块
   */
  public registerModule (modules: StoreModules, config?: any) {
    Store.modules.register(modules, config)
    if (cache.vuex.store) {
      addVuexState()
    }
  }
